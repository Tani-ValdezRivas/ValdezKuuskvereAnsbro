...
NitrogrenPlot <- ggplot(NitrogenYears, aes(x=Year, y=Nitrogen_Percent))+
  geom_boxplot()
print(NitrogrenPlot)

#6. Season Plot #average the months
Season <- ggplot(NitrogenYears, aes(X=))
...
#f_monthdaily <- month(first(NitrogenYears$Date))
#f_yeardaily <- year(first(NitrogenYears$Date))

#Nitrogen.daily.ts <- ts(NitrogenYears$Nitrogen_Percent,
