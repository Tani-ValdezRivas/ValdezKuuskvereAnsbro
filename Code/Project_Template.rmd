...
```{r, message=FALSE, fig.cap="Need's a name for list of figures"}
...
The jitter plot below shows the change in biomass uptake rate by nitrogen type with day replicate added.
...
NitrogenDayUptake <-
  ggplot(SurgeUptakeNitrogen, aes(x = Nitrogen_Types, y = Uptake_Rate, color = Day_Replicate)) +
...
What does these pvalues about the first data set tell us about the intro
