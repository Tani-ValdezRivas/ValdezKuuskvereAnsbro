...
UptakeRateBoxbyType
ggsave(file=here('Output', 'UptakeRateBoxbyType.png'), width = 10, height = 10, units = "cm")
...
BiomassBoxbyType
ggsave(file=here('Output', 'BiomassBoxbyType.png'), width = 10, height = 10, units = "cm")
...
ggsave(file=here('Output', 'UptakeRateBoxbySeason.png'), width = 10, height = 10, units = "cm")
...
BiomassBoxbySeason
ggsave(file=here('Output', 'BiomassBoxbySeason.png'), width = 10, height = 10, units = "cm")
...
UptakeRateBoxbyTime
ggsave(file=here('Output', 'UptakeRateBoxbyTime.png'), width = 10, height = 10, units = "cm")
...
BiomassBoxbyTime
ggsave(file=here('Output', 'BiomassBoxbyTime.png'), width = 10, height = 10, units = "cm")
...
ggsave(file=here('Output', 'UptakeRateBoxbyDayRep.png'), width = 10, height = 10, units = "cm")
...
BiomassBoxbyDayRep
ggsave(file=here('Output', 'BiomassBoxbyDayRep.png'), width = 10, height = 10, units = "cm")
...
ggsave(file=here('Output', 'UptakeRateBoxbyBladeRep.png'), width = 10, height = 10, units = "cm")
...
ggsave(file=here('Output', 'BiomassBoxbyBladeRep.png'), width = 10, height = 10, units = "cm")
```
...
ggsave(file=here('Output', 'UptakeRateViolinbyBladeRep.png'), width = 10, height = 10, units = "cm")
...
ggsave(file=here('Output', 'BiomassViolinbyBladeRep.png'), width = 10, height = 10, units = "cm")
