...
NitrogenYears_Processed <-read.csv(here('Data','Processed','NitrogenYears_Processed.csv'), stringsAsFactors=TRUE)
...
#Exploring Notrogen by Years Data
```{r}
summary(NitrogenYears_Processed)

summary(NitrogenYears_Processed$Nitrogen_Percent)

NitrogenYears_Point <- ggplot(NitrogenYears_Processed, aes(x=Year, y=Nitrogen_Percent))+
  geom_point(alpha=.5)+
  labs(title="Nitrogen Percent by Year", x="Date", y="Nitrogen Percent")

print(NitrogenYears_Point)

NitrogenYears_Box <- ggplot(NitrogenYears_Processed, aes(x=NewSites, y=Nitrogen_Percent))+
  geom_boxplot()+
